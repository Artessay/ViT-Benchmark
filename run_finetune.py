...
from model_loader import create_vit_model
...
def main():
    ...
    # 加载预训练的ViT模型
    vit_model = create_vit_model(model_name, num_classes=100)
    ...
    print(f'Accuracy of the finetuned model on the test images: {100 * accuracy_pretrained}%')
